...
ABE_URL = 'https://github.com/nyancoins/nyanchain'
...
<head>
    ...
    <script>
      ...
      ga('create', 'UA-36765833-6', 'nyanchain.info');
      ga('send', 'pageview');
    </script>
</head>
<body>
    <div class="header">
        <a href="%(dotdot)s%(HOMEPAGE)s"><img src="%(dotdot)s%(STATIC_PATH)snyanchain.png" alt="" width="350"></a>
    </div>
    <div class="content">
        ...
        <hr class="clear">
        <div class="footer">
            <a href="http://nyanchain.info/q"><i class="fa fa-code"></i>API</a>
            <a href="http://nyanchain.info/address/"><i class="fa fa-heart"></i>Donate</a>
        </div>
    </div>
</body>
</html>
